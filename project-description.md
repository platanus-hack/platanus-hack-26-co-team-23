# CumplIA — la IA que vigila la ley por tu empresa
...
CumplIA convierte la normativa colombiana en un **agente que trabaja para tu empresa**:
...
3. **Matching por perfil**: configuras tu empresa (tipo de sociedad + sectores) y CumplIA
...
5. **Cumplimiento en código** (plan PRO): el agente analiza tu repositorio en GitHub,
   ...
   cambio propuesto**, asignando como revisor al Tech Lead responsable. CumplIA propone —
...
- **Paquete npm `complia-mcp`**: cualquier persona conecta la normativa colombiana a Claude
  Desktop, Cursor o su agente con una línea: `npx -y complia-mcp`.

Hoy ningún agente puede responder con confianza *"¿qué norma me cambió esta semana?"* en
LatAm. CumplIA es esa infraestructura — el equivalente al [MCP de GovInfo](https://www.govinfo.gov/features/mcp-public-preview)
